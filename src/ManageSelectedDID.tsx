...
import { Box, Button, FormControl, Grid2, IconButton, MenuItem, Paper, Select, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material'
      ...
      <Table sx={{ minWidth: 650, maxWidth: '100%' }} aria-label="simple table">
        ...
        <TableBody>
          {managedDID?.keys.map((row) => (
            ...
            >
              <TableCell component="th" scope="row" sx={{ maxWidth: '300px', display: 'flex', alignItems: 'center'}}>
              ...
              <TableCell align="right"> <Typography noWrap>{row.type}</Typography></TableCell>
              <TableCell align="right" component="th" scope="row" sx={{ maxWidth: '300px', display: 'flex', alignItems: 'center'}}>
